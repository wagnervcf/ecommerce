        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Cadastro de Produto</h3>
                    <div class="row mb-3">
                                ...
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        <div class="card-header py-3">
                                            <p class="text-primary m-0 fw-bold">Cadastro produto</p>
                                        </div>
                                        <div class="card-body">
                                            <form action="cadproduto.php" method="POST" enctype="multipart/form-data">
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <input class="form-control" type="text" placeholder="Nome" name="nome"></div>
                                                    </div>
                                                    <div class="col">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <input class="form-control" type="text" placeholder="Quantidade" name="quantidade"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="valor"><strong>Valor</strong></label>
                                                        <input class="form-control" type="text" placeholder="Valor" name="valor"></div>
                                                        <div class="mb-3"><label class="form-label" for="valor"><strong>Foto</strong></label>
                                                        <input class="form-control" type="file" placeholder="Foto" name="foto1"></div>
                                                    </div>
                                                </div>
                                                <div class="mb-3"><button name="but_upload" class="btn btn-primary btn-sm" type="submit">Finalizar</button></div>
                                            </form>
                                        </div>
                                    </div>
                                </div>
